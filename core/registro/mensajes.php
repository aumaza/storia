...
<html lang="es">
    <head>
        ...
        <title>Storia - Tus Mensajes</title>
    ...
    <body id="page-top">
        ...
        <header class="bg-primary text-white">
            <div class="container text-center">
                ...
                <p>Si aún no estás registrado/a, te invitamos a ser parte de nuestra comunidad Storia, sólo dale click al botón "Registrate".</p>
            </div>
        </header>
        <?php
